...
char		window_title[]	= "3D Projections and Transformations";
...
//	glUniformMatrix4fv(projectionLoc, 1, GL_FALSE, glm::value_ptr(projection));
	glUniformMatrix4fv(projectionLoc, 1, GL_FALSE, glm::value_ptr(projection = calculateProjection()));
...
//	rotateM = glm::rotate(glm::mat4(1.0f), (float)glfwGetTime() * glm::radians(50.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	rotateM = glm::rotate(glm::mat4(1.0f), (GLfloat)currentTime * glm::radians(50.0f), glm::vec3(0.0f, 1.0f, 0.0f));
